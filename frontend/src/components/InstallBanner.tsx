      ...
      <div className="bg-slate-800 border border-slate-600 rounded-xl shadow-2xl p-4 flex flex-col gap-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <img src="/favicon.svg" className="w-10 h-10 rounded-xl flex-shrink-0" alt="" />
            <div>
              <p className="text-white font-semibold text-sm">Add to Home Screen</p>
              <p className="text-slate-400 text-xs">Use Watch Calendar like an app</p>
            </div>
          </div>
          <button onClick={dismiss} className="text-slate-500 hover:text-slate-300 mt-0.5 flex-shrink-0">
